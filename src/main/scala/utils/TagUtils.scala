...
object TagUtils {
  ...
  def getOneUserId(row: Row): String = {
    row match {
      ...
      case v if StringUtils.isNotBlank(v.getAs[String]("imeimd5")) => "IMD: " + v.getAs[String]("imeimd5")
      case v if StringUtils.isNotBlank(v.getAs[String]("macmd5")) => "MMD: " + v.getAs[String]("macmd5")
      case v if StringUtils.isNotBlank(v.getAs[String]("openudidmd5")) => "OPD: " + v.getAs[String]("openudidmd5")
      case v if StringUtils.isNotBlank(v.getAs[String]("androididmd5")) => "ADD: " + v.getAs[String]("androididmd5")
